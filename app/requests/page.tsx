...
// локальная, чтобы не зависеть от чужих импортов
...
async function getMy(userId: string): Promise<Row[]> {
  ...
  // 1) заявки без вложенных таблиц (устойчиво)
  ...
  // 2) подхватываем заголовок/город/обложку из вьюхи
...
export default async function RequestsPage() {
  ...
  try {
    ...
    // если вдруг что-то упало — покажем мягко пусто, а не 500
    rows = [];
  }
